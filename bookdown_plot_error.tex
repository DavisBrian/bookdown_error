...
\section{Plotting causes error}\label{plotting-causes-error}

Trying to ``Build Book''" with this plot causes an error. Removing the
plot book builds fine.
